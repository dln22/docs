...
| [Speaker identification](/speech-to-text/features/speaker-identification)             | Batch, Realtime | SaaS, On-prem<sup>1</sup> |
...
<sup>1</sup> On an on-prem deployment, batch speaker identification requires the [GPU speech-to-text container](/deployments/container/gpu-speech-to-text). Realtime speaker identification is supported on both CPU and GPU containers. See [speaker identification secrets](/deployments/container/speaker-identification).
