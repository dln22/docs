...
:::warning Batch speaker identification requires GPU inference
Speaker identification is not supported by the [CPU speech-to-text container](/deployments/container/cpu-speech-to-text) in batch mode. For batch processing, use the [GPU speech-to-text container](/deployments/container/gpu-speech-to-text). Realtime speaker identification is supported on both CPU and GPU containers.
:::
